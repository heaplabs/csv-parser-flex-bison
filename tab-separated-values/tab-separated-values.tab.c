...
#define YYSTYPE         TAB_SEPARATED_VALUES_STYPE
/* Substitute the variable and function names.  */
#define yyparse         tab_separated_values_parse
#define yylex           tab_separated_values_lex
#define yyerror         tab_separated_values_error
#define yydebug         tab_separated_values_debug
#define yynerrs         tab_separated_values_nerrs
#define yylval          tab_separated_values_lval
...
# define YYCOPY_NEEDED 1
     ...
     && (! defined __cplusplus \
         || (defined TAB_SEPARATED_VALUES_STYPE_IS_TRIVIAL && TAB_SEPARATED_VALUES_STYPE_IS_TRIVIAL)))
...
#if TAB_SEPARATED_VALUES_DEBUG || YYERROR_VERBOSE || 1
/* YYTNAME[SYMBOL-NUM] -- String name of the symbol SYMBOL-NUM.
   First, the terminals, then, starting at YYNTOKENS, nonterminals.  */
static const char *const yytname[] =
{
  "$end", "error", "$undefined", "TABSV_FIELD", "TABSV_QUOTED_FIELD",
...
int yydebug;
#else /* !TAB_SEPARATED_VALUES_DEBUG */
# define YYDPRINTF(Args)
# define YY_SYMBOL_PRINT(Title, Type, Value, Location)
# define YY_STACK_PRINT(Bottom, Top)
# define YY_REDUCE_PRINT(Rule)
#endif /* !TAB_SEPARATED_VALUES_DEBUG */
