...
int main(int argc, char * argv[])
{
	...
	int status_csv = tab_separated_values_parse (csv_record, all_csv_records_ref,
	...
	*/
	...
	if (tabLexerSpecificVars.tab_count > 0) {
		// cout << "input file has tabs:" 
		// 	<< tab_count
		// 	<< "num_lines: " << num_lines2 << endl;
		if (tabLexerSpecificVars.tab_count > num_lines2 ) {
