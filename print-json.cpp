...
int main()
{
	...
	// http://www.i18nguy.com/unicode/supplementary-test.html#utf8
	//
        
	string four_byte_unicode = 
		"𠜎 𩶘  𨋢 𣲷";
		cout << json_print(four_byte_unicode) << endl;
	string mixed_string = "IT Director ?? Supply Chain Delivery, ASPAC ";
		cout << json_print(mixed_string) << endl;
	
	string mix2 = "‪(623) ,,,,‪(623) ,,2-10,Marko,Sipilä,";
		cout << json_print(mix2) << endl;
	string mix3 = " - ·";
		cout << json_print(mix3) << endl;

	cout << "n_utf8_longer_than_1byte: " << n_utf8_longer_than_1byte
		<< ", n_wincp1252: " << n_wincp1252
		<< ", n_iso_8859_1: " << n_iso_8859_1
		<< endl;
}
