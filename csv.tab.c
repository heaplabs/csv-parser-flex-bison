...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_CSV_FIELD = 3,                  /* CSV_FIELD  */
  YYSYMBOL_QUOTED_CSV_FIELD = 4,           /* QUOTED_CSV_FIELD  */
  YYSYMBOL_DOUBLE_QUOTE = 5,               /* DOUBLE_QUOTE  */
  YYSYMBOL_6_n_ = 6,                       /* '\n'  */
  YYSYMBOL_7_ = 7,                         /* ','  */
  YYSYMBOL_YYACCEPT = 8,                   /* $accept  */
  YYSYMBOL_input = 9,                      /* input  */
  YYSYMBOL_record = 10,                    /* record  */
  YYSYMBOL_csv_field = 11                  /* csv_field  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "CSV_FIELD",
  "QUOTED_CSV_FIELD", "DOUBLE_QUOTE", "'\\n'", "','", "$accept", "input",
  "record", "csv_field", YY_NULLPTR
};
  ...
  if (yydebug)                                                            \
    {                                                                     \
      ...
      yy_symbol_print (stderr,                                            \
                  Kind, Value, csv_record, all_csv_records); \
      YYFPRINTF (stderr, "\n");                                           \
    }                                                                     \
} while (0)
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, vector<string> & csv_record, vector<vector<string>> & all_csv_records)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (csv_record);
  YY_USE (all_csv_records);
  if (!yyvaluep)
    return;
                 ...
                 yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, vector<string> & csv_record, vector<vector<string>> & all_csv_records)
{
  ...
  yy_symbol_value_print (yyo, yykind, yyvaluep, csv_record, all_csv_records);
  YYFPRINTF (yyo, ")");
}
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp,
                 int yyrule, vector<string> & csv_record, vector<vector<string>> & all_csv_records)
{
  ...
  for (yyi = 0; yyi < yynrhs; yyi++)
    {
      ...
      yy_symbol_print (stderr,
                       ...
                       &yyvsp[(yyi + 1) - (yynrhs)], csv_record, all_csv_records);
      YYFPRINTF (stderr, "\n");
    }
}
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, vector<string> & csv_record, vector<vector<string>> & all_csv_records)
{
  YY_USE (yyvaluep);
  YY_USE (csv_record);
  YY_USE (all_csv_records);
...
#line 1763 "csv.tab.c"
  ...
  case 6: /* record: record ',' csv_field  */
#line 233 "csv.y"
                               {
...
#line 1811 "csv.tab.c"
  ...
  case 9: /* csv_field: QUOTED_CSV_FIELD  */
#line 269 "csv.y"
                            {
		csv_record.push_back(yyvsp[0]);
		++ num_fields2;
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  YY_ACCESSING_SYMBOL (yystate), yyvsp, csv_record, all_csv_records);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  YY_ACCESSING_SYMBOL (+*yyssp), yyvsp, csv_record, all_csv_records);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
